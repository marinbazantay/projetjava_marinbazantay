...
public class ShotgunService implements IShotgunService {
	...
	public ShotgunService(ShotgunRepository shotgunRepository, 
			FamilleRepository familleRepository, ResidenceRepository residenceRepository,
	...
	public ShotgunDto createShotgun(ShotgunFormDto shotgunDto) throws Exception {
		...
		Residence residence = this.residenceRepository.findById(shotgunDto.getShotgunResidence()).get();
		...
		shotgunToCreate.setShotgunResidence(residence);
		...
		residence.addToResidence(shotgunToCreate);
	...
	private void validateShotgunInput(ShotgunFormDto shotgunDto) throws Exception {
		...
		if(shotgunDto.getShotgunResidence() < 1) {
			throw new Exception("La résidence qui shotgun ne peut être vide.");
		}
