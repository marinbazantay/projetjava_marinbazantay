...
public class Shotgun {
	...
	@JoinColumn
	private Residence shotgunResidence;
	...
	/**
	 * @return the shotgunResidence
	 */
	public Residence getShotgunResidence() {
		return shotgunResidence;
	}

	/**
	 * @param shotgunResidence
	 *            the shotgunResidence to set
	 */
	public void setShotgunResidence(Residence shotgunResidence) {
		this.shotgunResidence = shotgunResidence;
	}
}
